  ...
  React.useEffect(() => {
    ...
    const onRun = (e: Event) => {
       ...
       if (detail && detail.code) {
          // Use code from event (Generated by Workspace)
          const forcedLang = detail.forceLanguage ? detail.language : languageRef.current;
          ...
          // Fallback to prop-based code (Traditional way)
          runCode(getCode() ?? "");
       }
    };
    
    // Updated onRunStack to support forced language
    const onRunStack = (e: Event) => {
       const detail = (e as CustomEvent).detail;
