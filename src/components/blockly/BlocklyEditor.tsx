          ...
          <div className="h-14 flex items-center justify-between px-6 bg-white/80 backdrop-blur-xl border-b border-zinc-200/50 z-[60] sticky top-0 shadow-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`h-9 px-3 rounded-lg font-medium text-sm flex items-center gap-2 transition-all duration-200 ${showAISuggestion ? 'bg-purple-50 text-purple-600 ring-1 ring-purple-200' : 'bg-white text-zinc-600 hover:bg-zinc-50 ring-1 ring-zinc-200 shadow-sm'}`}
              >
